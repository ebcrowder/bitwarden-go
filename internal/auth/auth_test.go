...
import (
	...
	"github.com/ebcrowder/bitwarden-go/internal/database/mock"
)

func TestHandleLogin(t *testing.T) {
	keyHash, _ := reHashPassword("sjlcxv1TSe1wTHoYF50WJL3X07oCFxqhXYFeGfrbtII=", "nobody@example.com", 5000)
	db := &mock.MockDB{Username: "nobody@example.com", Password: keyHash, RefreshToken: "abcdef", KdfIterations: 5000}
	...
	cases := []struct {
		...
		{url.Values{"client_id": {"web"}, "grant_type": {"password"}, "username": {"nobody@example.com"}, "password": {"sjlcxv1TSe1wTHoYF50WJL3X07oCFxqhXYFeGfrbtII="}}, &mock.MockDB{Username: "nobody@example.com", Password: keyHash, RefreshToken: "abcdef", TwoFactorSecret: "ABC", KdfIterations: 5000}, 400}, // Test two factor login
	}
